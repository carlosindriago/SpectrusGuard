        ...
        <div class="wrap gs-dashboard">
            ...
            <div class="gs-dashboard-grid">
                ...
                <div class="gs-card gs-status-card">
                    ...
                    <div class="gs-card-body">
                        ...
                        <div class="gs-quick-stats">
                            <div class="gs-stat">
                                <span
                                    class="gs-stat-value"><?php echo esc_html(number_format($stats['total_blocked'])); ?></span>
                                <span class="gs-stat-label"><?php esc_html_e('Total Blocked', 'ghost-shield'); ?></span>
                            </div>
                            <div class="gs-stat">
                                <span
                                    class="gs-stat-value"><?php echo $stats['last_attack'] ? esc_html(human_time_diff(strtotime($stats['last_attack']))) . ' ago' : 'N/A'; ?></span>
                ...
                <!-- Security Scanner Card -->
                        <div class="gs-card gs-scanner-card <?php echo esc_attr($scan_status); ?>">
                            <div class="gs-card-header">
                                <h2>🔍 <?php esc_html_e('Security Scanner', 'ghost-shield'); ?></h2>
                            </div>
                            <div class="gs-card-body">
                                <?php if ($scan_status === 'never'): ?>
                                        <div class="gs-scanner-status never">
                                            <span class="gs-scanner-icon">🔎</span>
                                            <p class="gs-scanner-message">
                                                <?php esc_html_e('No security scan has been performed yet.', 'ghost-shield'); ?>
                                            </p>
                                            <p class="gs-scanner-cta">
                                                <?php esc_html_e('Run your first scan to check for malware, vulnerabilities, and security issues.', 'ghost-shield'); ?>
                                            </p>
                                        </div>
                                <?php elseif ($scan_status === 'old'): ?>
                                        <div class="gs-scanner-status old">
                                            <span class="gs-scanner-icon">⚠️</span>
                                            <p class="gs-scanner-message">
                                                <?php
                                                printf(
                                                    /* translators: %d: number of days since last scan */
                                                    esc_html__('Last scan was %d days ago.', 'ghost-shield'),
                                                    intval($days_since_scan)
                                                );
                                                ?>
                                            </p>
                                            <p class="gs-scanner-cta">
                                                <?php esc_html_e('We recommend scanning at least once a week to stay protected.', 'ghost-shield'); ?>
                                            </p>
                                        </div>
                                <?php else: ?>
                                        <div class="gs-scanner-status recent">
                                            <span class="gs-scanner-icon">✅</span>
                                            <p class="gs-scanner-message">
                                                <?php
                                                printf(
                                                    /* translators: %s: human readable time difference */
                                                    esc_html__('Last scan: %s ago', 'ghost-shield'),
                                                    esc_html(human_time_diff(strtotime($last_scan)))
                                                );
                                                ?>
                                            </p>
                                            <?php if ($threats_found > 0): ?>
                                                    <p class="gs-scanner-threats">
                                                        <span class="gs-threat-badge"><?php echo intval($threats_found); ?></span>
                                                        <?php
                                                        printf(
                                                            /* translators: %d: number of threats */
                                                            _n('threat found', 'threats found', $threats_found, 'ghost-shield'),
                                                            $threats_found
                                                        );
                                                        ?>
                                                    </p>
                                            <?php else: ?>
                                                    <p class="gs-scanner-clean"><?php esc_html_e('No threats detected', 'ghost-shield'); ?></p>
                                            <?php endif; ?>
                                        </div>
                                <?php endif; ?>
                                <a href="<?php echo esc_url(admin_url('admin.php?page=ghost-shield-scanner')); ?>" class="gs-scanner-btn">
                                    <span class="dashicons dashicons-search"></span>
                                    <?php echo $scan_status === 'never'
                                        ? esc_html__('Run First Scan', 'ghost-shield')
                                        : esc_html__('Go to Scanner', 'ghost-shield'); ?>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="gs-card gs-rescue-card">
                            ...
                            <div class="gs-card-body">
                                ...
                                <div class="gs-rescue-url">
                                    ...
                                    <button type="button" class="button gs-copy-btn"
                                        data-copy="<?php echo esc_attr(home_url('/?ghost_rescue=' . ($settings['rescue_key'] ?? ''))); ?>">
